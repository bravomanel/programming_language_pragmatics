public class QuickMain {
    ...
    public static void main(String[] args) {
        ...
        Container webContainer = new Container("webContainer");
        Container sqlContainer = new Container("sqlContainer");
        Container staticContainer = new Container("staticContainer");
